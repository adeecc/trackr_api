...
from .views import DocumentListAPIView, TodoListAPIView, TodoDetailAPIView, TodoItemListAPIView, TodoItemDetailAPIView,TodoItemEmailScheduleAPIView
...
urlpatterns = [
    ...
    path('schedule-email/', TodoItemEmailScheduleAPIView.as_view(), name='email-reminder'),
]
